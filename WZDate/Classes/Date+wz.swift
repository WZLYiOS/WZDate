...
//  SweepTreasure
//
//  Created by qiuqixiang on 2020/4/9.
...
public extension Date {
    ...
    /// 时间转化为时间戳
    /// - Parameter stringTime: 时间 格式yyyy年MM月dd日
    /// - Parameter formatterStr: 时间格式
    static func stringToTimeStamp(stringTime: String, formatterStr: String = "yyyy年MM月dd日") ->String {
    ...
    /// - Parameter formatterStr: 时间格式
    static func timeStampToString(timeStamp: String, formatterStr: String = "yyyy年MM月dd日") ->String {
    ...
    static func getDateFromTimeStamp(timeStamp: Int) -> Date {
